...
function Navbar(){
    ...
    const subCategoryList = [["1asdasdadddddddddddddddddsd", "2asdasd", "3asdasd"], ["4asdas", "5asdasd", "6asdasd"], ["7asdada", "8asdasda", "9"]];
        ...
        <nav className="navbar">
            <div className="navbar-container">
                <div className="navbar-brand">
                    ...
                    <a className="navbar-logo" href="/">Hachiko</a>
                </div>
                ...
                <form className="navbar-search">
                        ...
                        {openCategory && (
                            <ul className="navbar-category">
                                {categoryList.map((category, index)=>(
                                    (
                                        <>
                                        <li onMouseOver={()=>{setSelectedIndex(index)}}><a href="/">{category}</a></li>
                    ...
                    <input></input>
                    <button className="navbar-search-button" type="submit"><img src={require("../assets/search.png")} alt="Search"/></button>
                </form>
                ...
                <div className="navbar-item">
                    ...
                    <a className="navbar-user" href="/">{name}</a>
